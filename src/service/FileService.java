...
//Реализовать FileService, который по имени csv файла возвращает список объектов класса ImageDescriptor,
//который содержит URL картинки и название действия.
//List<FileDescriptor> readFileDescriptors()
